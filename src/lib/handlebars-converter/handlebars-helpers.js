...
module.exports.external = [
    ...
    {
        name: 'getClinicalDocumentNodes',
        description: "returns ClinicalDocument nodes",
        func: function getClinicalDocumentNodes(msg, ...templateIds) {
            let rets = msg.ClinicalDocument.component.structuredBody.component;
            return rets;
        }
    },
    {
