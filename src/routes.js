...
module.exports = function (app) {
    ...
    app.get('/api/templates/:file(*)', function (req, res) {
        console.log('ttttt6 = ',req.params.file);
    ...
    */
    app.post('/api/convert/:srcDataType', function (req, res) {
        console.log('ttttt2', req.params.srcDataType);
       /* if( req.params.srcDataType == 'csv') {
            //console.log(req.body.srcDataBase64);  
            var base64data = req.body.srcDataBase64; 
            let xmlParser = require('xml2json');
            let buff = new Buffer.from(base64data, 'base64');
            let text = buff.toString('ascii');
            //console.log('text==',text);
            var output = xmlParser.toJson(text);  
            console.log('output= ', output);
            res.status(200); 
            res.json(output);
            return; 
        }*/
       // console.log('srcDataType=',req.params.srcDataType);
        workerPool.exec({
            ...
            //console.log('res==',result.resultMsg);
